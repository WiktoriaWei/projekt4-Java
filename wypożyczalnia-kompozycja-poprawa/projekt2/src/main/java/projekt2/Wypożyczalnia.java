...
public class Wypożyczalnia {
    ...
    public void addDaneproduktu(Książki x) //dodaje dane produktu do listy
    {
        zbior.add(x.Daneproduktu);
    }
    ...
    public void addDaneproduktu(Płyty mf) {
    }

    public void addDaneproduktu(Filmy marvel) {
    }

    public void addDaneproduktu(Ebooki prog) {
    }

    public void addDaneproduktu(Audiobooki bajki) {
    }
}
